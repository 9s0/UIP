...
pcall(function()
	userinfo = HttpService:JSONDecode(readfile("9s0lib.txt"));
end)
...
local function SaveInfo()
	...
	userinfo["user"] = user
	userinfo["tag"] = tag
	writefile("9s0lib.txt", HttpService:JSONEncode(userinfo));
end
...
local s0Liba = Instance.new("ScreenGui")
s0Liba.Name = "9s0"
s0Liba.Parent = game.CoreGui
s0Liba.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function s0Lib:Window(text)
	...
	Title.Text = text
	Title.TextColor3 = Color3.fromRGB(255, 123, 29)
	...
	ServersHoldFrame.BackgroundColor3 = Color3.fromRGB(30,30,30)
	ServersHoldFrame.BackgroundTransparency = 1.000
	ServersHoldFrame.BorderColor3 = Color3.fromRGB(30,30,30)
	...
	function s0Lib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.BackgroundColor3 = Color3.fromRGB(30,30,30)
		...
		AlrightBtn.MouseEnter:Connect(function()
			TweenService:Create(
				AlrightBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(255, 123, 29)}
			):Play()
		end)
	...
	function ServerHold:Server(text, img)
		...
		Server.BackgroundColor3 = Color3.fromRGB(35,35,35)
		...
		ServerContentFrame.BackgroundColor3 = Color3.fromRGB(10,10,10)
		...
		ChannelContentFrame.BackgroundColor3 = Color3.fromRGB(40,40,40)
		...
		ServerChannelHolder.ScrollBarImageColor3 = Color3.fromRGB(10,10,10)
		...
		function ChannelHold:Channel(text)
			...
			ChannelBtn.BackgroundColor3 = Color3.fromRGB(45,45,45)
			...
			ChannelBtnHashtag.TextColor3 = Color3.fromRGB(15,15,15)
			...
			ChannelBtn.MouseEnter:Connect(function()
				if currentchanneltoggled ~= ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(55,55,55)
			...
			ChannelBtn.MouseLeave:Connect(function()
				if currentchanneltoggled ~= ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(50,50,50)
					ChannelBtnTitle.TextColor3 = Color3.fromRGB(114, 118, 125)
				end
			end)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				ToggleFrameCircle.BackgroundColor3 = Color3.fromRGB(10,10,10)
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(255, 123, 29)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(255, 123, 29)
				...
				ValueBubble.BackgroundColor3 = Color3.fromRGB(35,35,35)
				...
				SquareBubble.BackgroundColor3 = Color3.fromRGB(35,35,35)
			...
			function ChannelContent:Seperator()
				...
				Seperator2.BackgroundColor3 = Color3.fromRGB(55,55,55)
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownFrameMain.BackgroundColor3 = Color3.fromRGB(40,40,40)
				...
				for i,v in next, list do
					...
					ItemText.BackgroundColor3 = Color3.fromRGB(20,20,20)
			...
			function ChannelContent:Textbox(text, placetext, disapper, callback)
				...
				TextBox.Focused:Connect(function()
					TweenService:Create(
						TextboxFrameOutline,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(255, 136, 17)}
					):Play()
				end)
